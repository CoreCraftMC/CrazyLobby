package me.corecraft.common.constants;
...
public class MessageKeys {
    ...
    public static final Key bypass_toggle = Key.key(namespace, "bypass_toggle");
    public static final Key bypass_toggle_enabled = Key.key(namespace, "bypass_toggle_enabled");
    public static final Key bypass_toggle_disabled = Key.key(namespace, "bypass_toggle_disabled");
