...
public class RootKeys implements SettingsHolder {
    ...
    public void registerComments(@NotNull final CommentsConfiguration configuration) {
        ...
        configuration.setComment("messages.commands",
                """
                All per command messages.
                """);

        configuration.setComment("messages.commands.bypass",
                """
    ...
    public static final Property<String> reload_plugin = newProperty("messages.reload-plugin", "{prefix}<green>You have reloaded the plugin!");
