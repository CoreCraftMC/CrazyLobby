...
public enum Permissions {
    ...
    event_item_interact("event.item.interact", "Ability to interact with items", PermissionDefault.OP, true),
    event_player_pvp("event.player.pvp", "Allows the player to pvp", PermissionDefault.OP, true),
    ...
    private final CrazyLobbyPlugin plugin = CrazyLobbyPlugin.getPlugin();
